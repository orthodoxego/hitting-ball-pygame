...
class Text:
    ...
    def __init__(self):
        self.__font_help = pygame.font.Font("font\kelly.ttf", 26)
        self.__font_score = pygame.font.Font("font\kelly.ttf", 38)
        self.help_surface_text = self.__font_help.render("Для ускорения шара отбейте его площадкой (зажмите ЛКМ).", True, (150, 150, 175))
